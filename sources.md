...
Follow these as **nodes**, not merely individual repositories. Check their READMEs, credits, linked predecessors/successors, author repository lists, tools, forum references and curated lists.

| Source | Reason |
|---|---|
| https://github.com/tetracorp | Multiple Amiga RE projects plus external RE references |
...
- linked tools/predecessor projects
